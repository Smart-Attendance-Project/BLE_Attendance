...
Duration get kScanCycleInterval => Platform.isAndroid
...
Uint8List _encodePayload(String content) =>
...
class _TeacherPageState extends State<TeacherPage> {
  ...
  Map<String, dynamic>? _extractStudentPayload(DiscoveredDevice device) {
    try {
      ...
      if (payload.startsWith('T|') || payload.startsWith('T2|')) return null;
  ...
  Uint8List _encodeTeacherPayload(
    int divisionId,
    int? batchId,
    String subject,
    int seq,
